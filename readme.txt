This project contains experiments to compare the method with our hybridized method (NSLC) combining mEDEA and novelty search with local competition
...
Installation:
To install this project roborobo4 must first be installed. The instructions on how to do this can be found here: 
https://github.com/nekonaute/roborobo4
